  ...
  return (
    <main
      className={`flex flex-col items-center px-16 pt-11 pb-20 ${
        darkModeEnabled === "true" ? "background-dark" : "background-light"
      } max-md:px-5`}
    >
                ...
                {locations.slice(0, 4).map((location, index) => (
                  <Button
                    sx={{
                      ...
                      "&:hover": {
                        color: darkModeEnabled === "true" ? "#2bb9a9" : "black",
                        backgroundColor:
                          darkModeEnabled === "true" ? "#2bb9a9" : "#2bb9a9",
                      },
                    }}
                    key={index}
                    onClick={() =>
                      handleCityClick(location.coordinates, location.city)
                    }
                  >
                    <Location {...location} />
                  </Button>
