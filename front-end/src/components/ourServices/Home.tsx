        ...
        <div className="flex justify-center items-center flex-col gap-[70px]">
            ...
            >
                ...
                <div className="flex absolute flex-col gap-8 text-white">
                    <h1 className="flex flex-start text-5xl leading-10">
                        WE ARE ON OUR WAY
                    </h1>
