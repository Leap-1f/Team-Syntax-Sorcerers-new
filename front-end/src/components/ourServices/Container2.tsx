...
export const Container2 = () => {
    const services = [
        {
            img: "https://res.cloudinary.com/dqhy9ufze/image/upload/v1714993643/SERVICES_3-1_w20nig.png",
            title: "Packing",
            description:
        ...
        {
            img: "https://res.cloudinary.com/dqhy9ufze/image/upload/v1714993639/SERVICES_2-1_xsh7wb.png",
            title: "Shipping",
            description:
                "Nunc et augue pulvinar, luctus mi non, sagittis odio. Phasellus congue sem nulla.non sodales orci malesu da vel. Aliquam mi eros.",
        },
        {
            img: "https://res.cloudinary.com/dqhy9ufze/image/upload/v1714993631/SEVICES_1-1_jxpzdt.png",
            title: "Delivery",
            description:
        ...
        <div className="color-black flex justify-center items-center flex-col gap-[70px] ">
            ...
            <div className="flex w-[1150px] justify-between">
                {services.map((service, index) => (
                    <div
                        key={index}
                        className="h-[440px] w-[340px] border border-black"
                    >
                        <div className="w-full h-[35%] bg-[#dee2e6] relative">
                            <Image
                                src={service.img}
                                alt="service"
                                layout="fill"
